...
export default function Address() {
    ...
    // Function to show error message based on error type
    ...
    // Function to fetch user's address details
    ...
    // Fetch address details when user changes
    useEffect(() => {
        useIsLoading(true)
        getAdddress()
    }, [user])

    // Function to set the current address details in state
            ...
            <MainLayout>
                ...
                >
                    <div className="p-3 mx-auto bg-white rounded-lg">
                        ...
                        <div className="mb-2 text-xl text-bold">Address Details</div>
